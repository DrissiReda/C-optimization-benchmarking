...
0000000000000800 <main>:
 ...
 8d1:	48 8d 35 de 03 00 00 	lea    0x3de(%rip),%rsi        # cb6 <_IO_stdin_used+0x46>
 ...
 93c:	4c 8d 3d 76 03 00 00 	lea    0x376(%rip),%r15        # cb9 <_IO_stdin_used+0x49>
 ...
 9b5:	48 8d 3d 06 03 00 00 	lea    0x306(%rip),%rdi        # cc2 <_IO_stdin_used+0x52>
...
0000000000000b90 <baseline>:
 b90:	4c 63 c7             	movslq %edi,%r8
 b93:	85 ff                	test   %edi,%edi
 b95:	7e 45                	jle    bdc <baseline+0x4c>
 b97:	8d 47 ff             	lea    -0x1(%rdi),%eax
 b9a:	49 c1 e0 03          	shl    $0x3,%r8
 b9e:	c5 f9 57 c0          	vxorpd %xmm0,%xmm0,%xmm0
 ...
 bbe:	00 00 
 bc0:	c5 fb 58 00          	vaddsd (%rax),%xmm0,%xmm0
 ...
 bdb:	c3                   	retq   
 bdc:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
 be0:	c3                   	retq   
