...
0000000000400fe0 <main>:
  ...
  401035:	0f 8c f7 03 00 00    	jl     401432 <main+0x452>
  ...
  401094:	44 89 7d b0          	mov    %r15d,-0x50(%rbp)
  ...
  4010ca:	44 8b 7d b0          	mov    -0x50(%rbp),%r15d
  ...
  4010f2:	c5 fd 10 05 06 19 00 	vmovupd 0x1906(%rip),%ymm0        # 402a00 <_IO_stdin_used+0x20>
  4010f9:	00 
  ...
  401107:	0f 8c 10 03 00 00    	jl     40141d <main+0x43d>
  ...
  401199:	0f 8c 8b 02 00 00    	jl     40142a <main+0x44a>
  ...
  4011f7:	be 70 2a 40 00       	mov    $0x402a70,%esi
  ...
  401211:	be 80 2a 40 00       	mov    $0x402a80,%esi
  ...
  401242:	48 89 45 b8          	mov    %rax,-0x48(%rbp)
  401246:	44 89 f9             	mov    %r15d,%ecx
  401249:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
  40124d:	41 0f af cf          	imul   %r15d,%ecx
  401251:	45 33 ed             	xor    %r13d,%r13d
  401254:	0f af 4d a0          	imul   -0x60(%rbp),%ecx
  401258:	c5 fa 2a c1          	vcvtsi2ss %ecx,%xmm0,%xmm0
  40125c:	c5 fa 11 45 c0       	vmovss %xmm0,-0x40(%rbp)
  401261:	83 7d c8 00          	cmpl   $0x0,-0x38(%rbp)
  401265:	0f 8e df 00 00 00    	jle    40134a <main+0x36a>
  40126b:	4c 89 65 88          	mov    %r12,-0x78(%rbp)
  40126f:	44 89 7d b0          	mov    %r15d,-0x50(%rbp)
  401273:	49 89 d7             	mov    %rdx,%r15
  401276:	e8 95 fb ff ff       	callq  400e10 <rdtsc>
  40127b:	49 89 c4             	mov    %rax,%r12
  40127e:	4c 89 f6             	mov    %r14,%rsi
  401281:	8b 7d b0             	mov    -0x50(%rbp),%edi
  401284:	e8 97 fb ff ff       	callq  400e20 <baseline>
  401289:	e8 82 fb ff ff       	callq  400e10 <rdtsc>
  40128e:	48 89 c1             	mov    %rax,%rcx
  401291:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
  401295:	49 2b cc             	sub    %r12,%rcx
  401298:	c4 e1 fa 2a c1       	vcvtsi2ss %rcx,%xmm0,%xmm0
  40129d:	79 1a                	jns    4012b9 <main+0x2d9>
  40129f:	48 89 c8             	mov    %rcx,%rax
  4012a2:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
  4012a6:	48 d1 e9             	shr    %rcx
  4012a9:	48 83 e0 01          	and    $0x1,%rax
  4012ad:	48 0b c1             	or     %rcx,%rax
  4012b0:	c4 e1 fa 2a c0       	vcvtsi2ss %rax,%xmm0,%xmm0
  4012b5:	c5 fa 58 c0          	vaddss %xmm0,%xmm0,%xmm0
  4012b9:	c5 fa 5e 4d c0       	vdivss -0x40(%rbp),%xmm0,%xmm1
  4012be:	c5 fa 10 05 62 17 00 	vmovss 0x1762(%rip),%xmm0        # 402a28 <_IO_stdin_used+0x48>
  4012c5:	00 
  4012c6:	48 b9 00 00 00 00 00 	movabs $0x8000000000000000,%rcx
  4012cd:	00 00 80 
  4012d0:	c5 f8 2f c8          	vcomiss %xmm0,%xmm1
  4012d4:	c5 f2 5c d8          	vsubss %xmm0,%xmm1,%xmm3
  4012d8:	c5 f2 c2 d0 0d       	vcmpgess %xmm0,%xmm1,%xmm2
  4012dd:	73 04                	jae    4012e3 <main+0x303>
  4012df:	c5 f8 28 d9          	vmovaps %xmm1,%xmm3
  4012e3:	c4 61 fa 2c c3       	vcvttss2si %xmm3,%r8
  4012e8:	c5 f9 7e d0          	vmovd  %xmm2,%eax
  4012ec:	4c 8b 4d b8          	mov    -0x48(%rbp),%r9
  4012f0:	48 63 c0             	movslq %eax,%rax
  4012f3:	48 23 c1             	and    %rcx,%rax
  4012f6:	4c 03 c0             	add    %rax,%r8
  4012f9:	4f 89 04 e9          	mov    %r8,(%r9,%r13,8)
  4012fd:	49 ff c5             	inc    %r13
  401300:	4d 3b ef             	cmp    %r15,%r13
  401303:	0f 8c 6d ff ff ff    	jl     401276 <main+0x296>
  401309:	33 d2                	xor    %edx,%edx
  40130b:	45 33 ed             	xor    %r13d,%r13d
  40130e:	41 89 d4             	mov    %edx,%r12d
  401311:	4c 89 75 90          	mov    %r14,-0x70(%rbp)
  401315:	4d 89 ce             	mov    %r9,%r14
  401318:	4c 8b 7d a8          	mov    -0x58(%rbp),%r15
  40131c:	41 ff c4             	inc    %r12d
  40131f:	4c 89 ff             	mov    %r15,%rdi
  401322:	be 84 2a 40 00       	mov    $0x402a84,%esi
  401327:	44 89 e2             	mov    %r12d,%edx
  40132a:	33 c0                	xor    %eax,%eax
  40132c:	4b 8b 0c ee          	mov    (%r14,%r13,8),%rcx
  401330:	e8 fb f8 ff ff       	callq  400c30 <fprintf@plt>
  401335:	49 ff c5             	inc    %r13
  401338:	44 3b 65 c8          	cmp    -0x38(%rbp),%r12d
  40133c:	7c de                	jl     40131c <main+0x33c>
  40133e:	4c 8b 65 88          	mov    -0x78(%rbp),%r12
  401342:	4c 8b 75 90          	mov    -0x70(%rbp),%r14
  401346:	44 8b 7d b0          	mov    -0x50(%rbp),%r15d
  40134a:	e8 c1 fa ff ff       	callq  400e10 <rdtsc>
  40134f:	49 89 c5             	mov    %rax,%r13
  401352:	33 c0                	xor    %eax,%eax
  401354:	83 7d a0 00          	cmpl   $0x0,-0x60(%rbp)
  401358:	7e 2a                	jle    401384 <main+0x3a4>
  40135a:	4c 89 6d 90          	mov    %r13,-0x70(%rbp)
  40135e:	4c 89 65 88          	mov    %r12,-0x78(%rbp)
  401362:	41 89 c4             	mov    %eax,%r12d
  401365:	44 8b 6d a0          	mov    -0x60(%rbp),%r13d
  401369:	44 89 ff             	mov    %r15d,%edi
  40136c:	4c 89 f6             	mov    %r14,%rsi
  40136f:	e8 ac fa ff ff       	callq  400e20 <baseline>
  401374:	41 ff c4             	inc    %r12d
  401377:	45 3b e5             	cmp    %r13d,%r12d
  40137a:	7c ed                	jl     401369 <main+0x389>
  40137c:	4c 8b 6d 90          	mov    -0x70(%rbp),%r13
  401380:	4c 8b 65 88          	mov    -0x78(%rbp),%r12
  401384:	e8 87 fa ff ff       	callq  400e10 <rdtsc>
  401389:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
  40138d:	49 2b c5             	sub    %r13,%rax
  401390:	c4 e1 fa 2a c0       	vcvtsi2ss %rax,%xmm0,%xmm0
  401395:	79 1a                	jns    4013b1 <main+0x3d1>
  401397:	48 89 c2             	mov    %rax,%rdx
  40139a:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
  40139e:	48 d1 e8             	shr    %rax
  4013a1:	48 83 e2 01          	and    $0x1,%rdx
  4013a5:	48 0b d0             	or     %rax,%rdx
  4013a8:	c4 e1 fa 2a c2       	vcvtsi2ss %rdx,%xmm0,%xmm0
  4013ad:	c5 fa 58 c0          	vaddss %xmm0,%xmm0,%xmm0
  4013b1:	c5 fa 5e 45 c0       	vdivss -0x40(%rbp),%xmm0,%xmm0
  4013b6:	bf 90 2a 40 00       	mov    $0x402a90,%edi
  4013bb:	b8 01 00 00 00       	mov    $0x1,%eax
  4013c0:	c5 fa 5a c0          	vcvtss2sd %xmm0,%xmm0,%xmm0
  4013c4:	e8 47 f8 ff ff       	callq  400c10 <printf@plt>
  4013c9:	48 8b 7d a8          	mov    -0x58(%rbp),%rdi
  4013cd:	e8 fe f7 ff ff       	callq  400bd0 <fclose@plt>
  4013d2:	45 33 ed             	xor    %r13d,%r13d
  4013d5:	45 85 ff             	test   %r15d,%r15d
  4013d8:	7e 15                	jle    4013ef <main+0x40f>
  4013da:	4c 8b 7d 98          	mov    -0x68(%rbp),%r15
  4013de:	4b 8b 3c ee          	mov    (%r14,%r13,8),%rdi
  4013e2:	e8 99 f7 ff ff       	callq  400b80 <free@plt>
  4013e7:	49 ff c5             	inc    %r13
  4013ea:	4d 3b ef             	cmp    %r15,%r13
  4013ed:	7c ef                	jl     4013de <main+0x3fe>
  4013ef:	4c 89 f7             	mov    %r14,%rdi
  4013f2:	e8 89 f7 ff ff       	callq  400b80 <free@plt>
  4013f7:	4c 89 e0             	mov    %r12,%rax
  4013fa:	48 8b 55 b8          	mov    -0x48(%rbp),%rdx
  4013fe:	48 83 c0 1f          	add    $0x1f,%rax
  401402:	48 83 e0 e0          	and    $0xffffffffffffffe0,%rax
  401406:	48 03 e0             	add    %rax,%rsp
  401409:	33 c0                	xor    %eax,%eax
  40140b:	48 8d 65 e0          	lea    -0x20(%rbp),%rsp
  40140f:	41 5f                	pop    %r15
  401411:	41 5e                	pop    %r14
  401413:	41 5d                	pop    %r13
  401415:	41 5c                	pop    %r12
  401417:	5d                   	pop    %rbp
  401418:	48 89 dc             	mov    %rbx,%rsp
  40141b:	5b                   	pop    %rbx
  40141c:	c3                   	retq   
  40141d:	4d 8b 08             	mov    (%r8),%r9
  401420:	89 ce                	mov    %ecx,%esi
  401422:	45 33 db             	xor    %r11d,%r11d
  401425:	e9 2e fd ff ff       	jmpq   401158 <main+0x178>
  40142a:	45 33 d2             	xor    %r10d,%r10d
  40142d:	e9 93 fd ff ff       	jmpq   4011c5 <main+0x1e5>
  401432:	bf 40 2a 40 00       	mov    $0x402a40,%edi
  401437:	e8 74 f7 ff ff       	callq  400bb0 <puts@plt>
  40143c:	bf 01 00 00 00       	mov    $0x1,%edi
  401441:	e8 4a f8 ff ff       	callq  400c90 <exit@plt>
  401446:	0f 1f 00             	nopl   (%rax)
