...
0000000000000800 <main>:
 ...
 859:	49 c1 e5 03          	shl    $0x3,%r13
 85d:	48 89 45 a8          	mov    %rax,-0x58(%rbp)
 861:	e8 4a ff ff ff       	callq  7b0 <strtol@plt>
 866:	4c 89 ee             	mov    %r13,%rsi
 869:	bf 01 00 00 00       	mov    $0x1,%edi
 86e:	48 89 45 80          	mov    %rax,-0x80(%rbp)
 872:	89 45 94             	mov    %eax,-0x6c(%rbp)
 875:	e8 16 ff ff ff       	callq  790 <calloc@plt>
 87a:	45 85 f6             	test   %r14d,%r14d
 87d:	49 89 c4             	mov    %rax,%r12
 880:	7e 63                	jle    8e5 <main+0xe5>
 882:	49 89 c7             	mov    %rax,%r15
 885:	48 8b 45 88          	mov    -0x78(%rbp),%rax
 889:	83 e8 01             	sub    $0x1,%eax
 88c:	4d 8d 74 c4 08       	lea    0x8(%r12,%rax,8),%r14
 891:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
 898:	4c 89 ee             	mov    %r13,%rsi
 ...
 8b2:	f2 0f 10 05 ee 04 00 	movsd  0x4ee(%rip),%xmm0        # da8 <_IO_stdin_used+0x58>
 8b9:	00 
 8ba:	31 c9                	xor    %ecx,%ecx
 8bc:	0f 1f 40 00          	nopl   0x0(%rax)
 8c0:	49 8b 14 cc          	mov    (%r12,%rcx,8),%rdx
 8c4:	31 c0                	xor    %eax,%eax
 8c6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
 8cd:	00 00 00 
 8d0:	f2 0f 11 04 c2       	movsd  %xmm0,(%rdx,%rax,8)
 ...
 9b1:	0f 2e 05 f8 03 00 00 	ucomiss 0x3f8(%rip),%xmm0        # db0 <_IO_stdin_used+0x60>
 9b8:	72 b6                	jb     970 <main+0x170>
 9ba:	f3 0f 5c 05 ee 03 00 	subss  0x3ee(%rip),%xmm0        # db0 <_IO_stdin_used+0x60>
 9c1:	00 
 ...
 9e8:	4c 8d 3d aa 03 00 00 	lea    0x3aa(%rip),%r15        # d99 <_IO_stdin_used+0x49>
 ...
 a63:	48 8d 3d 38 03 00 00 	lea    0x338(%rip),%rdi        # da2 <_IO_stdin_used+0x52>
 ...
 b1b:	48 8d 3d 36 02 00 00 	lea    0x236(%rip),%rdi        # d58 <_IO_stdin_used+0x8>
...
0000000000000b40 <_start>:
 ...
 b4d:	50                   	push   %rax
 b4e:	54                   	push   %rsp
 b4f:	4c 8d 05 ea 01 00 00 	lea    0x1ea(%rip),%r8        # d40 <__libc_csu_fini>
 b56:	48 8d 0d 73 01 00 00 	lea    0x173(%rip),%rcx        # cd0 <__libc_csu_init>
...
0000000000000c80 <baseline>:
 ...
 c82:	48 63 cf             	movslq %edi,%rcx
 c85:	66 0f ef c0          	pxor   %xmm0,%xmm0
 c89:	7e 3c                	jle    cc7 <baseline+0x47>
 c8b:	8d 47 ff             	lea    -0x1(%rdi),%eax
 c8e:	66 0f ef c0          	pxor   %xmm0,%xmm0
 c92:	48 c1 e1 03          	shl    $0x3,%rcx
 c96:	4c 8d 44 c6 08       	lea    0x8(%rsi,%rax,8),%r8
 c9b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
 ca0:	48 89 f2             	mov    %rsi,%rdx
 ca3:	31 c0                	xor    %eax,%eax
 ca5:	0f 1f 00             	nopl   (%rax)
 ca8:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
 cac:	83 c0 01             	add    $0x1,%eax
 caf:	f2 0f 58 02          	addsd  (%rdx),%xmm0
 cb3:	48 01 ca             	add    %rcx,%rdx
 cb6:	39 c7                	cmp    %eax,%edi
 cb8:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
 cbc:	75 ea                	jne    ca8 <baseline+0x28>
 cbe:	48 83 c6 08          	add    $0x8,%rsi
 cc2:	4c 39 c6             	cmp    %r8,%rsi
 cc5:	75 d9                	jne    ca0 <baseline+0x20>
 cc7:	f3 c3                	repz retq 
 cc9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

0000000000000cd0 <__libc_csu_init>:
 cd0:	41 57                	push   %r15
 cd2:	41 56                	push   %r14
 cd4:	41 89 ff             	mov    %edi,%r15d
 cd7:	41 55                	push   %r13
 cd9:	41 54                	push   %r12
 cdb:	4c 8d 25 f6 10 20 00 	lea    0x2010f6(%rip),%r12        # 201dd8 <__frame_dummy_init_array_entry>
 ce2:	55                   	push   %rbp
 ce3:	48 8d 2d f6 10 20 00 	lea    0x2010f6(%rip),%rbp        # 201de0 <__init_array_end>
 cea:	53                   	push   %rbx
 ...
 cfc:	e8 27 fa ff ff       	callq  728 <_init>
 d01:	48 85 ed             	test   %rbp,%rbp
 d04:	74 20                	je     d26 <__libc_csu_init+0x56>
 ...
 d21:	48 39 dd             	cmp    %rbx,%rbp
 d24:	75 ea                	jne    d10 <__libc_csu_init+0x40>
...
0000000000000d40 <__libc_csu_fini>:
 d40:	f3 c3                	repz retq 

Disassembly of section .fini:

0000000000000d44 <_fini>:
