...
-- If the application does not use OpenMP, the value can be egal to 1, nil
...
run_command="<binary> 20000 50 70"="<binary> 20000 50 70" = " <binary> 30 300 30" 
