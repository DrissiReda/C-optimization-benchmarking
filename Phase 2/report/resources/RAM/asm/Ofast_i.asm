...
0000000000400ed0 <main>:
  ...
  400f04:	0f 8c 2f 02 00 00    	jl     401139 <main+0x269>
  ...
  40108b:	45 0f af ff          	imul   %r15d,%r15d
  40108f:	66 0f ef c0          	pxor   %xmm0,%xmm0
  401093:	f3 0f 10 0d bd 0f 00 	movss  0xfbd(%rip),%xmm1        # 402058 <_IO_stdin_used+0x58>
  40109a:	00 
  40109b:	45 0f af fc          	imul   %r12d,%r15d
  40109f:	f3 41 0f 2a c7       	cvtsi2ss %r15d,%xmm0
  4010a4:	f3 0f 5e c8          	divss  %xmm0,%xmm1
  4010a8:	66 0f ef c0          	pxor   %xmm0,%xmm0
  4010ac:	49 2b c6             	sub    %r14,%rax
  4010af:	f3 48 0f 2a c0       	cvtsi2ss %rax,%xmm0
  4010b4:	79 1a                	jns    4010d0 <main+0x200>
  4010b6:	48 89 c2             	mov    %rax,%rdx
  4010b9:	66 0f ef c0          	pxor   %xmm0,%xmm0
  4010bd:	48 d1 e8             	shr    %rax
  4010c0:	48 83 e2 01          	and    $0x1,%rdx
  4010c4:	48 0b d0             	or     %rax,%rdx
  4010c7:	f3 48 0f 2a c2       	cvtsi2ss %rdx,%xmm0
  4010cc:	f3 0f 58 c0          	addss  %xmm0,%xmm0
  4010d0:	f3 0f 59 c8          	mulss  %xmm0,%xmm1
  4010d4:	bf 54 20 40 00       	mov    $0x402054,%edi
  4010d9:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
  4010dd:	0f 28 c1             	movaps %xmm1,%xmm0
  4010e0:	b8 01 00 00 00       	mov    $0x1,%eax
  4010e5:	e8 c6 fa ff ff       	callq  400bb0 <printf@plt>
  4010ea:	48 8b 7d c0          	mov    -0x40(%rbp),%rdi
  4010ee:	e8 7d fa ff ff       	callq  400b70 <fclose@plt>
  4010f3:	45 33 e4             	xor    %r12d,%r12d
  4010f6:	48 85 db             	test   %rbx,%rbx
  4010f9:	7e 12                	jle    40110d <main+0x23d>
  4010fb:	4b 8b 7c e5 00       	mov    0x0(%r13,%r12,8),%rdi
  401100:	e8 2b fa ff ff       	callq  400b30 <free@plt>
  401105:	49 ff c4             	inc    %r12
  401108:	4c 3b e3             	cmp    %rbx,%r12
  40110b:	7c ee                	jl     4010fb <main+0x22b>
  40110d:	4c 89 ef             	mov    %r13,%rdi
  401110:	e8 1b fa ff ff       	callq  400b30 <free@plt>
  401115:	48 8b 55 d0          	mov    -0x30(%rbp),%rdx
  401119:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  40111d:	48 83 c0 0f          	add    $0xf,%rax
  401121:	48 83 e0 f0          	and    $0xfffffffffffffff0,%rax
  401125:	48 03 e0             	add    %rax,%rsp
  401128:	33 c0                	xor    %eax,%eax
  40112a:	48 8d 65 d8          	lea    -0x28(%rbp),%rsp
  40112e:	5b                   	pop    %rbx
  ...
  401137:	5d                   	pop    %rbp
  401138:	c3                   	retq   
  401139:	bf 04 20 40 00       	mov    $0x402004,%edi
  40113e:	e8 0d fa ff ff       	callq  400b50 <puts@plt>
  401143:	bf 01 00 00 00       	mov    $0x1,%edi
  401148:	e8 f3 fa ff ff       	callq  400c40 <exit@plt>
...
0000000000401150 <__intel_new_feature_proc_init>:
  ...
  401283:	48 8d 35 4e 0f 00 00 	lea    0xf4e(%rip),%rsi        # 4021d8 <_IO_stdin_used+0x1d8>
...
00000000004014c0 <__libirc_get_msg>:
  ...
  40154e:	48 8d 3d 87 0c 00 00 	lea    0xc87(%rip),%rdi        # 4021dc <_IO_stdin_used+0x1dc>
  ...
  401683:	c3                   	retq   
  401684:	48 8d 3d f5 10 00 00 	lea    0x10f5(%rip),%rdi        # 402780 <_IO_stdin_used+0x780>
  ...
  4016c8:	48 8d 3d b1 10 00 00 	lea    0x10b1(%rip),%rdi        # 402780 <_IO_stdin_used+0x780>
  ...
  4016e6:	48 8d 3d ef 0a 00 00 	lea    0xaef(%rip),%rdi        # 4021dc <_IO_stdin_used+0x1dc>
  4016ed:	33 f6                	xor    %esi,%esi
  4016ef:	e8 ec f4 ff ff       	callq  400be0 <catopen@plt>
  4016f4:	48 8d 3d 85 10 00 00 	lea    0x1085(%rip),%rdi        # 402780 <_IO_stdin_used+0x780>
...
0000000000401740 <__libirc_print>:
  ...
  4017cc:	48 8d 35 15 0a 00 00 	lea    0xa15(%rip),%rsi        # 4021e8 <_IO_stdin_used+0x1e8>
  ...
  40180b:	48 8d 3d ca 09 00 00 	lea    0x9ca(%rip),%rdi        # 4021dc <_IO_stdin_used+0x1dc>
  ...
  401902:	48 8d 35 df 08 00 00 	lea    0x8df(%rip),%rsi        # 4021e8 <_IO_stdin_used+0x1e8>
  ...
  401945:	48 8d 15 9c 08 00 00 	lea    0x89c(%rip),%rdx        # 4021e8 <_IO_stdin_used+0x1e8>
  ...
  40195b:	48 8d 3d 1e 0e 00 00 	lea    0xe1e(%rip),%rdi        # 402780 <_IO_stdin_used+0x780>
  ...
  40199b:	48 8d 3d de 0d 00 00 	lea    0xdde(%rip),%rdi        # 402780 <_IO_stdin_used+0x780>
  ...
  4019b7:	48 8d 3d 1e 08 00 00 	lea    0x81e(%rip),%rdi        # 4021dc <_IO_stdin_used+0x1dc>
  4019be:	33 f6                	xor    %esi,%esi
  4019c0:	e8 1b f2 ff ff       	callq  400be0 <catopen@plt>
  4019c5:	48 8d 3d b4 0d 00 00 	lea    0xdb4(%rip),%rdi        # 402780 <_IO_stdin_used+0x780>
  ...
  401a1c:	48 8d 15 c5 07 00 00 	lea    0x7c5(%rip),%rdx        # 4021e8 <_IO_stdin_used+0x1e8>
